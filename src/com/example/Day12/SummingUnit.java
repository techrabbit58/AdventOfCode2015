...
public class SummingUnit {
    ...
    private final List<Integer> allNonRedNumbers = new ArrayList<>();

    private boolean objectIsRed = false;
    ...
    public List<Integer> getAllNonRedNumbers() {
        return allNonRedNumbers;
    }
    ...
    private void adjustStack() {
        ...
        System.out.print(currentAtom);
        if (opStack.peek().equals(NUMBER)) {
            allNumbers.add(Integer.parseInt(currentAtom.toString()));
        }
        opStack.pop();
        currentAtom = null;
    }
